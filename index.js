...
//
// ======================================
function TransportStderr ( options ){
	options = options || {};
...
TransportStderr.prototype.getColor = function getColor(group){
	// Color Formatting
	// ----------------------------------
...
TransportStderr.prototype.batchLog = function batchLog(){
...
// --------------------------------------
TransportStderr.prototype.name = 'Console';

TransportStderr.prototype.log = function TransportStderrLog( loggedObject ){
	// log
...
module.exports = TransportStderr;